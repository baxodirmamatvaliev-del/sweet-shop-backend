...
export enum Message {
  ...
  INVALID_PHONE = "Telefon raqamini 010-1234-5678 formatida kiriting.",
  INVALID_QUICK_ORDER_STATUS = "Quick-order holati noto‘g‘ri.",
  QUICK_ORDER_NOT_FOUND = "Quick-order so‘rovi topilmadi.",
